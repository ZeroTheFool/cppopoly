...
{
    chanceDeck[0] = new GameCard("get 50", "you get 50", 50, 1, functionType::Receive, functionTarget::Bank);
    chanceDeck[1] = new GameCard("pay 50", "you pay 50", 50, 1, functionType::Pay, functionTarget::All);
    chanceDeck[2] = new GameCard("move to Go", "go to Go", 0, 1, functionType::MoveToIndex, functionTarget::None);
}
